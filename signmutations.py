print("This program finds a list of mutations against a Reference sequence that is conserved across multiple sequences")
print("V1.0. Code Compiled by: Varun CN, NIMHANS")
print("Require a multifasta file that contains sequences and a .xlsx file that has the list of sequences and their QC. status. Works best with NextClade output")
